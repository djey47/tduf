...
class TdupeGatewayTest {
    ...
    @Test
    void applyPerformancePackToEntryWithIdentifier_whenEntryExists_shouldInvokeMinerAndPatcher() throws ReflectiveOperationException, IOException, URISyntaxException {
        // GIVEN
    ...
    @Test
    void applyPerformancePackToEntryWithIdentifier_whenEntryDoesNotExist_shouldInvokeMinerAndPatcher() throws ReflectiveOperationException, IOException, URISyntaxException {
        // GIVEN
        String performancePackFile = thisClass.getResource("/db/patch/tdupe/F150.tdupk").getFile();
    ...
    @Test
    void applyPerformancePackToEntryWithReference_shouldInvokeMinerAndPatcher() throws ReflectiveOperationException, IOException, URISyntaxException {
        // GIVEN
        String performancePackFile = thisClass.getResource("/db/patch/tdupe/F150.tdupk").getFile();
    ...
    @Test
    void checkCarPhysicsDataLine_whenNullLine_shouldThrowException(){
        // GIVEN-WHEN-THEN
    ...
    @Test
    void checkCarPhysicsDataLine_whenIncorrectLine_shouldThrowException() {
        // GIVEN-WHEN-THEN
    ...
    @Test
    void checkCarPhysicsDataLine_whenCorrectLine_shouldNotThrowException() {
        // GIVEN-WHEN
