...
package fr.tduf.libunlimited.framework.primitives;

import fr.tduf.libunlimited.framework.base.Converter;
...
public final class Longs {
    ...
    public static long[] toArray(Collection<? extends Number> collection) {
        ...
        for (int i = 0; i < len; i++) {
            // requireNonNull for GWT (do not optimize)
