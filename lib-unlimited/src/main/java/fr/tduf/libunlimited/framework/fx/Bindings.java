...
/**
 * Provides utility methods for Java FX bindings
 */
public class Bindings {
    ...
    /**
     * Adds a change listener to a property that will not react to changes caused (transitively) by itself
     *  (i.e. from an update call in the call tree that is a descendant of itself.)
