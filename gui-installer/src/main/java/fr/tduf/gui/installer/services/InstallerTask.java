...
abstract class InstallerTask extends Task<Void> {
    ...
    protected InstallerTask(ObjectProperty<InstallerConfiguration> configuration, ObjectProperty<DatabaseContext> context) {
    ...
    protected void callStepChain(GenericStep.StepType... steps) throws StepException {
        try {
